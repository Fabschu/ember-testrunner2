...
# Global deps
RUN npm install -g bower@1.7.1 xo cordova-icon cordova-splash lodash@">=4.3.0" elementtree@">=0.1.6" plist@">=1.2.0" xcode@">=0.8.9" colors@">=1.1.2" shelljs@">=0.7.0" tostr@">=0.1.0" jshint@">=2.6.0" got@">=6.5.0"
